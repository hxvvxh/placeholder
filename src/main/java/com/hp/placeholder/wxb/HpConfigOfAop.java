...
/**
 *启动注解式的aop
 * EnableAspectJAutoProxy 参考 AspectJAutoProxyRegistrar
 * 除了自定义的@
 * spring自己注册一个bean到spring中(动态代理 Cglib)
 * @see org.springframework.boot.autoconfigure.aop.AopAutoConfiguration$AspectJAutoProxyingConfiguration$CglibAutoProxyConfiguration
 */
@EnableAspectJAutoProxy
@Configuration
public class HpConfigOfAop {

    /**
     * 将自定义的log aop 交给spring来处理
     * @return
     */
    @Bean
