 ...
 */
@Configuration
public class ConfigOfAutoConfiguration {
    ...
    /**
     * @Bean 标注的方法创建对象时，方法默认从ioc容器中获取。所以入参属性不需要写@Autowired
     * @param auto
     * @return
     */
    @Bean
    public AutoOfOther buildAutoOfOther(Auto auto){
        AutoOfOther autoOfOther=new AutoOfOther();
        autoOfOther.setAuto(auto);
        return autoOfOther;
    }
}
